class BarChart extends Chart {
  ...
  void frame() {
    ...
    strokeWeight(gui.unit(2));
    rangeX=chartWidth-gui.thisFont.stepX(2)-textWidth(maxY+labelY);
    ...
    arrow(x+textWidth(maxY+"")+gui.thisFont.stepX(), y+chartHeight-gui.thisFont.stepY(), x+textWidth(maxY+"")+gui.thisFont.stepX(), y+gui.thisFont.stepY());
    arrow(x+textWidth(maxY+"")+gui.thisFont.stepX()-gui.thisFont.gap(), y+chartHeight-gui.thisFont.stepY()-gui.thisFont.gap(), x+chartWidth-gui.thisFont.stepX()-textWidth(labelX), y+chartHeight-gui.thisFont.stepY()-gui.thisFont.gap());
    stepX=stepY=1;
    ...
    for (int i=0; i<=(maxX-minX)/stepX; i++)
      line(textWidth(maxX+""+maxY)+x+gui.thisFont.stepX()+i*gapX, y+chartHeight-gui.thisFont.stepY(), textWidth(maxX+""+maxY)+x+gui.thisFont.stepX()+i*gapX, y+gui.thisFont.stepY()+rangeY);
    ...
    textAlign(CENTER);
    for (int i=0; i<=(maxX-minX)/stepX; i++)
      text(i*stepX, x+textWidth(maxY+""+maxX)+gui.thisFont.stepX()+i*gapX, y+chartHeight);
